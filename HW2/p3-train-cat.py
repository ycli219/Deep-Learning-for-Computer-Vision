...
image_paths = [
    "../../../H2O/hw2_data/textual_inversion/cat/04.jpg",
    "../../../H2O/hw2_data/textual_inversion/cat/03.jpg",
    "../../../H2O/hw2_data/textual_inversion/cat/02.jpg",
    "../../../H2O/hw2_data/textual_inversion/cat/01.jpg",
    "../../../H2O/hw2_data/textual_inversion/cat/00.jpg"
]

general_prompts = [
    "a photo of a <new3>",
    "a rendering of a <new3>",
    "a cropped photo of the <new3>",
    "the photo of a <new3>",
    "a photo of my <new3>",
    "a photo of the cute <new3>",
    "a close-up photo of a <new3>",
    "a bright photo of the <new3>",
    "a cropped photo of a <new3>",
    "a photo of the <new3>",
    "a good photo of the <new3>",
    "a photo of one <new3>",
    "a close-up photo of the <new3>",
    "a rendition of the <new3>",
    "a rendition of a <new3>",
    "a photo of a nice <new3>",
    "a good photo of a <new3>",
    "a photo of the nice <new3>",
    "a photo of a cute <new3>"
]
...
if num_added_tokens > 0:
    ...
    for token in new_tokens:
        ...
        token_embeds[token_id] = token_embeds[tokenizer.convert_tokens_to_ids('cat')].clone()
...
for epoch in range(num_epochs):
    ...
    if (epoch + 1) <= 100:
        ...
        embedding_save_path = os.path.join("./embed7", f"embedding_new3_epoch_{epoch+1}.pth") 
